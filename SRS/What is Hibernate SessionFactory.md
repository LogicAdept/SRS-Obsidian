...
See [[What is Hibernate as an ORM framework]], [[What is the difference between JPA as a specification and Hibernate]], [[How does the Hibernate first-level cache work in Spring]], [[What are Hibernate first and second level cache tiers]], [[What is Hibernate second level cache and its main components]], [[What is Hibernate entity lifecycle states]], [[Is the Hibernate Session thread-safe]], and [[What advantages does Hibernate provide over plain JDBC]].
