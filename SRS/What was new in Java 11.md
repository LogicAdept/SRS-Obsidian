...
> **Java 11 is the first LTS of the new cadence: standard HTTP client, String/Files ergonomics, var in lambda params, single-file launch, Epsilon and experimental ZGC, open JFR, TLS 1.3 — and the removal of Java EE and CORBA modules.** The removals are the migration story; the HTTP client is the API story. Method-level detail: [[What methods were added to String after Java 8]]; the JFR line: [[How did JVM profiling and observability evolve after Java 8]].
