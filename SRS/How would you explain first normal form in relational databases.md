...
The next two rungs depend on this one: [[How would you explain second normal form in relational normalization]] and [[How would you explain third normal form in relational databases]]; the whole ladder in [[What is normalization]]; the stricter rungs above 3NF: [[What is Boyce-Codd normal form and how does it differ from 3NF]] and [[What is fourth normal form and what are multivalued dependencies]].
